...
eeg_lab_specs = {
    "TUD": {
        ...
        "sidecar": {
            ...
            # "SoftwareFilters": "n/a",
            "HardwareFilters": {
                "Bandpass": {"Low cutoff (s)": 10, "High cutoff (Hz)": 250}
            },
    ...
    "CIM": {
        ...
        "sidecar": {
            ...
            # "SoftwareFilters": "n/a",
            "HardwareFilters": {
                "Bandpass": {"Low cutoff (Hz)": 0.1, "High cutoff (Hz)": 100}
            },
    ...
    "GUF": {
        ...
        "sidecar": {
            ...
            # "SoftwareFilters": "n/a",
            "HardwareFilters": {
                "Bandpass": {"Low cuttoff (s)": 10, "High cuttoff (Hz)": 100}
            },
            "SoftwareVersions": "1.23.003",
            # "DeviceSerialNumber": "n/a",
            # "HeadCircumference": "n/a",
    ...
    "MSH": {
        ...
        "sidecar": {
            ...
            # "SoftwareFilters": "n/a",
            "HardwareFilters": {
                "Bandpass": {"Low cuttoff (s)": 10, "High cuttoff (Hz)": 1000}
            },
    ...
    "URE": {
        ...
        "sidecar": {
            ...
            "EEGGround": "AFz",
            # "SoftwareFilters": "n/a",
            "HardwareFilters": {"Lowpass": {"High cuttoff (Hz)": 250}},
            # "SoftwareVersions": "n/a",
            # "DeviceSerialNumber": "n/a",
            # "HeadCircumference": "n/a",
        },
